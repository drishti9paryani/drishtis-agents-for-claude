...
echo "  - agents/tars-secure.md"
echo "  - agents/rancho-ideas.md"
echo "  - skills/unagi-askfirst/SKILL.md"
echo ""
echo "Restart Claude Code, then try: 'run tars-secure' or '/unagi-askfirst'"
