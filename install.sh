...
echo "  - agents/checkandsecure.md"
echo "  - agents/feature-scout.md"
echo "  - skills/ask-drish-now/SKILL.md"
echo ""
echo "Restart Claude Code, then try: 'run checkandsecure' or '/ask-drish-now'"
